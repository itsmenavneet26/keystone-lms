...
def execute():
	frappe.reload_doc("keystone_lms", "doctype", "course_chapter")
	frappe.reload_doc("keystone_lms", "doctype", "course_lesson")
	frappe.reload_doc("keystone_lms", "doctype", "chapter_reference")
	frappe.reload_doc("keystone_lms", "doctype", "lesson_reference")
	frappe.reload_doc("keystone_lms", "doctype", "exercise")
	frappe.reload_doc("keystone_lms", "doctype", "exercise_submission")
	frappe.reload_doc("keystone_lms", "doctype", "lms_batch_membership")
	frappe.reload_doc("keystone_lms", "doctype", "lms_course")
	frappe.reload_doc("keystone_lms", "doctype", "lms_course_progress")
	frappe.reload_doc("keystone_lms", "doctype", "lms_quiz")
